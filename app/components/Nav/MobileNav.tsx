    ...
    <>
      ...
      {toggleMenu && (
        <>
          ...
          <nav
            className={`z-50 fixed top-0 bottom-0 right-0 flex flex-col w-full max-w-sm py-6 px-6 overflow-y-auto border-l ${
          ...
          >
            <div className="flex items-center justify-start mb-16">
              <button
                className={`${
                  isDark
                    ? "hover:text-darkTextAccent"
                    : "hover:text-lightTextAccent"
                }`}
                onClick={() => setToggleMenu(false)}
              >
                <svg
            ...
            <div className="flex flex-col justify-center">
              <button onClick={() => setToggleMenu(false)}>
                <Link className="mx-auto font-bold text-2xl" href="/">
                  Aesthete&apos;s Digest
                </Link>
              </button>
            ...
            <div className="mt-auto flex flex-col justify-center items-center gap-8">
              ...
              <div className="mx-auto lg:my-auto body2 py-4">
                <p>
                  &copy; {year} Aesthete&apos;s Digest. All Rights Reserved.
                </p>
              </div>
            </div>
          </nav>
